...
- [WePY：组件化的小程序开发框架](https://github.com/Tencent/wepy)
- [WePY 开发资源汇总](https://github.com/aben1188/awesome-wepy)
- [ZanUI-WeApp: 高颜值、好用、易扩展的微信小程序 UI 库，Powered by 有赞](https://github.com/youzan/zanui-weapp)
- [Taro: 用 React 的方式开发小程序](https://github.com/NervJS/taro)
...
- [WePY ★10k+](https://github.com/Tencent/wepy) -  支持组件化的小程序开发框架
- [mpvue ★8.7k](https://github.com/Meituan-Dianping/mpvue) - 基于 Vue.js 的小程序开发框架，从底层支持 Vue.js 语法和构建工具体系
- [Taro ★3.9k](https://github.com/NervJS/taro) - 使用 React 的方式开发小程序的框架，同时支持生成多端应用
